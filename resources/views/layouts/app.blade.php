      ...
      <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item">
          <a class="c-sidebar-nav-link" href="{{  url('/home')  }}">
            <i class="fas fa-home"></i> __Dashboard  <span class="badge badge-info">NEW</span></a></li>
        <li class="c-sidebar-nav-title">Theme</li>
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="colors.html">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="{{ asset('assets/dashboard/vendors/@coreui/icons/svg/free.svg#cil-drop1') }}"></use>
            </svg> Colors</a></li>
        ...
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="#">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="{{ asset('assets/dashboard/vendors/@coreui/icons/svg/free.svg#cil-cursor')  }}"></use>
            </svg> Buttons</a>
          <ul class="c-sidebar-nav-dropdown-items">
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="charts.html">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="{{ asset('assets/dashboard/vendors/@coreui/icons/svg/free.svg#cil-chart-pie') }}"></use>
            </svg> Charts</a></li>
        ...
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="widgets.html">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="{{ asset('assets/dashboard/vendors/@coreui/icons/svg/free.svg#cil-calculator') }}"></use>
      ...
      <header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav ml-auto mr-4">
          ...
          <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              <div class="c-avatar"><img class="c-avatar-img" src={{ asset('assets/dashboard/assets/img/avatars/6.jpg') }} title="{{ Auth::user()->name }}" alt=" {{ Auth::user()->name }}"></div>
              
              <div > <label>  {{ Auth::user()->name }} </label></div>
        ...
        <div class="c-subheader px-3">
          <!-- Breadcrumb link segundo comando-->
          <ol class="breadcrumb border-0 m-0">
            <li class="breadcrumb-item">Dashboard</li>
            <li class="breadcrumb-item active">Bienvenido Usuario:{{ Auth::user()->name}} <br>Fecha de hoy: {{  date('l F Y g:i:s ' ) }} </li> 
            <!-- Breadcrumb Menu-->
          </ol>
        </div>
      </header>
